...
describe('Get User', function () {
  it('GET /api/auth', function (done) {
    chai
      ...
      .set(
        'x-auth-token',
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNWYwYjAyZmNkZTViMDcyYWNjMzBhYmE2In0sImlhdCI6MTU5NDU1NzE4MCwiZXhwIjoxNTk0OTg5MTgwfQ.nRwsnVJnP3wtnvOBsV3VDj9w8H5iU8lvRCErUaMIH7M'
      )
